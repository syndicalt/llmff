...
The next package-publication release should be cut as `v0.1.4` after this
...
Unsigned Windows and macOS artifacts are acceptable for v0.1.4. Windows release
...
After release CI completes for `v0.1.4`, verify the published GitHub Release
