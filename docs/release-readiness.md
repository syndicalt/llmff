...
The next package-publication release should be cut as `v0.1.5` after this
...
Unsigned Windows and macOS artifacts are acceptable for v0.1.5. Windows release
...
After release CI completes for `v0.1.5`, verify the published GitHub Release
